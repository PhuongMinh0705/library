...
$sql="update  dulieu_sach set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookPrice=:price where id=:bookid";
...
<?php 
$bookid=intval($_GET['bookid']);
$sql = "SELECT dulieu_sach.BookName,dulieu_theloai.CategoryName,dulieu_theloai.id as cid,dulieu_tacgia.AuthorName,dulieu_tacgia.id as athrid,dulieu_sach.ISBNNumber,dulieu_sach.BookPrice,dulieu_sach.id as bookid from  dulieu_sach join dulieu_theloai on dulieu_theloai.id=dulieu_sach.CatId join dulieu_tacgia on dulieu_tacgia.id=dulieu_sach.AuthorId where dulieu_sach.id=:bookid";
$query = $dbh -> prepare($sql);
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR);
$query->execute();
...
<?php 
$status=1;
$sql1 = "SELECT * from  dulieu_theloai where Status=:status";
...
$sql2 = "SELECT * from  dulieu_tacgia ";
