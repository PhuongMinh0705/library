...
{
$id=$_GET['del'];
$sql = "delete from dulieu_sach  WHERE id=:id";
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT dulieu_sach.BookName,dulieu_theloai.CategoryName,dulieu_tacgia.AuthorName,dulieu_sach.ISBNNumber,dulieu_sach.BookPrice,dulieu_sach.id as bookid from  dulieu_sach join dulieu_theloai on dulieu_theloai.id=dulieu_sach.CatId join dulieu_tacgia on dulieu_tacgia.id=dulieu_sach.AuthorId";
$query = $dbh -> prepare($sql);
$query->execute();
