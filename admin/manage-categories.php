...
{
$id=$_GET['del'];
$sql = "delete from dulieu_theloai  WHERE id=:id";
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from  dulieu_theloai";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                          ...
                                          <a href="manage-categories.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn đồng ý xóa thể loại ?    ');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Xóa</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
