...
$status=1;
$sql="INSERT INTO  dulieu_docgia(StudentId,FullName,MobileNumber,EmailId,Password,Status) VALUES(:StudentId,:fname,:mobileno,:email,:password,:status)";
...
if($lastInsertId)
{
echo '<script>alert("Đăng kí thành công, Mã độc giả của bạn là  "+"'.$StudentId.'")</script>';
}
else 
{
